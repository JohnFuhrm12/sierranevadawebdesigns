        ...
        <div id='portfolioBackground'>
          ...
          <div className='infoBlocks'>
            <div className='infoBlock'>
                <h2 id='subtitlePortfolio' className='subTitlePage'><span className='titleBlue'>{content.subtitlePortfolioBlue}</span>{content.subtitlePortfolio}</h2>
                <div className='contentWrapperPortfolio'>
                    <div className='contentBlockImgPortfolio'>
                        ...
                        <button className='portfolioButton' onClick={aquatics}>{content.portfolioButton}</button>
                    </div>
                    <div className='contentBlockTextPortfolio'>
                        <h2 className='subTitlePage'><span className='titleBlue'>{content.portfolioPieceSubtitleBlue1}</span>{content.portfolioPieceSubtitle1}</h2>
                        <p className='infoParaLarge'>{content.portfolioPieceParagraph1}</p>
                    </div>
                </div>
                <div className='contentWrapperPortfolio'>
                    <div className='contentBlockTextPortfolio'>
                        <h2 className='subTitlePage'><span className='titleBlue'>{content.portfolioPieceSubtitleBlue2}</span>{content.portfolioPieceSubtitle2}</h2>
                    ...
                    <div className='contentBlockImgPortfolio'>
                        ...
                        <button className='portfolioButton' onClick={surf}>{content.portfolioButton}</button>
                    </div>
                </div>
                <div className='contentWrapperPortfolio'>
                    <div className='contentBlockImgPortfolio'>
                        ...
                        <button className='portfolioButton' onClick={dharma}>{content.portfolioButton}</button>
                    </div>
                    <div className='contentBlockTextPortfolio'>
                        <h2 className='subTitlePage'><span className='titleBlue'>{content.portfolioPieceSubtitleBlue3}</span>{content.portfolioPieceSubtitle3}</h2>
