...
function Services( {...props} ) {
    ...
    return (
        <>
        <div className='background' id='servicesBackground'>
          ...
          <div className='infoBlocks'>
            ...
            <div className='infoBlock'>
                <h2 className='subTitle'><span className='titleColor'>{content.seoSubtitleBlue}</span>{content.seoSubtitle}</h2>
                <p className='infoParaLarge'>{content.seoParagraph}</p>
            </div>
            <div className='backgroundSquare' id='servicesSecondBackground'>
                <div className='infoBlockTransparent'>
                    <h2 className='subTitlePage'>{content.transparentTitle}</h2>
                    <h2 className='subTitleSmall'><span className='subTitleSmallColor'>{content.transparentSubtitleBlue1}</span>{content.transparentSubtitle1}</h2>
                    <h2 className='subTitleSmall'><span className='subTitleSmallColor'>{content.transparentSubtitleBlue2}</span>{content.transparentSubtitle2}</h2>
                    <h2 className='subTitleSmall'><span className='subTitleSmallColor'>{content.transparentSubtitleBlue3} </span>{content.transparentSubtitle3}</h2>
                    <h2 className='subTitleSmall'><span className='subTitleSmallColor'>{content.transparentSubtitleBlue4} </span> {content.transparentSubtitle4}</h2>
                    <h2 className='subTitleSmall'><span className='subTitleSmallColor'>{content.transparentSubtitleBlue5}</span>{content.transparentSubtitle5}</h2>
                    <h2 className='subTitleSmall'><span className='subTitleSmallColor'>{content.transparentSubtitleBlue6}</span>{content.transparentSubtitle6}</h2>
                    <h2 className='subTitleSmall'><span className='subTitleSmallColor'>{content.transparentSubtitleBlue7} </span>{content.transparentSubtitle7}</h2>
                </div>
            </div>
            <div className='infoBlock'>
                <h2 className='subTitle'><span className='titleColor'>{content.maintananceSubtitleBlue}</span>{content.maintananceSubtitle}</h2>
